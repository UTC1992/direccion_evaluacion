...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $prevMonthNavIcon = $('<span><i class="fa fa-angle-left"></i></span>');
            var $nextMonthNavIcon = $('<span><i class="fa fa-angle-right"></i></span>');
            ...
            if (events !== false) {
                $(events).each(function (index, value) {
                    ...
                    if (typeof(value.url) !== 'undefined') {
                        $dowElement.attr('url', value.url);
                    }
                    if (typeof(value.location) !== 'undefined') {
                        $dowElement.attr('location', value.location);
                    }
